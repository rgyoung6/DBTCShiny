...
This repository contains the DBTCShiny package located at [rgyoung6/DBTCShiny](https://github.com/rgyoung6/DBTCShiny). For tutorial on the use of the [DBTCShiny](https://github.com/rgyoung6/DBTCShiny) package please see [DBTCShinyTutorial](https://github.com/rgyoung6/DBTCShinyTutorial) on GitHub. The Dada-BLAST-Taxon Assign-Condense Shiny package contains the foundational [DBTC](https://github.com/rgyoung6/DBTC) functions (able to be run through the command line) which have been wrapped in a Shiny application for easy user interface. The DBTC functions have four main outcomes...
...
After installation of the DBTCShiny and all of its dependencies (including [DBTC](https://github.com/rgyoung6/DBTC) and all of its dependencies) you need to load the package and then run the Shiny Graphical User Interface (GUI) using the following commands...
